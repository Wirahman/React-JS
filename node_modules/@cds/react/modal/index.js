...
export const CdsModal = removeFalseHiddenProp(createComponent(React, 'cds-modal', Modal, {
...
export const CdsModalHeaderActions = createComponent(React, 'cds-modal-header-actions', ModalHeaderActions, {}, 'CdsModalHeaderActions');
